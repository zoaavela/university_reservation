...
<head>
    ...
    <title>Accueil Enseignant - Système de Réservation Universitaire</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-2 sidebar">
                <h4 class="text-center mb-4">Espace Enseignant</h4>
            ...
            <div class="col-md-10 content">
                <div class="welcome-card">
                    ...
                    <p>Vous êtes connecté en tant qu'enseignant. Utilisez le menu de gauche pour naviguer.</p>
                </div>
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <ul>
                            ...
                            <li>Pour toute assistance technique, veuillez contacter le service informatique au support-tech@universite.fr</li>
                        </ul>
                    </div>
                </div>
            </div>
