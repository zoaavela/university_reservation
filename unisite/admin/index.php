...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">MMI Admin</a>
    ...
    <div class="container mt-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
                        <a href="utilisateurs.php" class="btn btn-outline-primary btn-block mb-2">Gérer les utilisateurs</a>
                    </div>
                    <div class="col-md-3">
                        <a href="materiel.php" class="btn btn-outline-success btn-block mb-2">Gérer le matériel</a>
                    </div>
                    <div class="col-md-3">
                        <a href="salles.php" class="btn btn-outline-warning btn-block mb-2">Gérer les salles</a>
                    </div>
                    <div class="col-md-3">
                        <a href="reservations.php" class="btn btn-outline-info btn-block mb-2">Gérer les réservations</a>
                    </div>
                </div>
            </div>
        </div>
